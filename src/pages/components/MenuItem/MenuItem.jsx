const MenuItem = ({ item }) => {
  ...
  return (
    <div className="flex items-start gap-5 md:gap-8 group">
      {/* Image */}
      <div className="w-[110px] h-[80px] md:w-[130px] md:h-[90px] overflow-hidden shrink-0 rounded-tr-[200px] rounded-br-[200px] rounded-bl-[200px]">
        <img
          src={image}
          alt={name}
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between mb-2 border-b border-dotted border-gray-300 pb-1">
          ...
          <p className="text-sm md:text-base text-yellow-500 font-medium">${price}</p>
        </div>
